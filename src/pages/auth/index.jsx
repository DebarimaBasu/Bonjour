      ...
      <div className="flex flex-col gap-10 items-center justify-center">
        <div className="flex items-center justify-center flex-col">
         ...
         <Tabs className="w-3/4">
          ...
          <TabsTrigger 
          value="login"
          className="data-[state=active]:bg-transparent text-blue-950 text-opacity-90 border-b-2 rounded-none w-full
          data-[state=active]:text-blue-950 data-[state=active]:font-semibold data-[state=active]:border-b-purple-400 
